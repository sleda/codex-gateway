  ...
  return {
    ...
    connectorCompatibility: {
      ...
      publicActionContract: {
        ...
        snapshot: 'v0.3-published-compatible',
        diagnostic: 'The public action schema is intentionally pinned for published-app reconnect compatibility. Do not claim the Gateway is read-only from UI shape alone: gateway_info workspaceRuns.writesEnabled, codex.mutationsEnabled, and discoverable mutation tools are authoritative. Use tool_call with the target confirmation when writes are enabled.',
      },
    },
